function createUnityInstance(t, n, l) {
    ...
    ;
    var s, u, f, h, b, m, p, g, w = "", v = "", y = (document.addEventListener("webkitfullscreenchange", function(e) {
        document.webkitCurrentFullScreenElement === t ? t.style.width && (w = t.style.width,
        v = t.style.height,
        t.style.width = "100%",
        t.style.height = "100%") : w && (t.style.width = w,
        t.style.height = v,
        v = w = "")
    }),
    {
    ...
    c.SystemInfo = function() {
        ...
        var u, c = {
            ...
            "NT 6.3": "8.1",
            "NT 10.0": "10"
        }[c] || c, f = ((f = document.createElement("canvas")) && (u = (h = f.getContext("webgl2")) ? 2 : 0,
    ...
    ,
    function(r, o) {
        var e, t, a = m.getInstance(), n = E("string" == typeof r ? r : r.url), i = {
            enabled: (e = n,
        ...
        function s(e, t) {
            return g(e, t).then(function(e) {
                if (i.enabled && !i.revalidated) {
                    if (304 === e.status)
                        return i.result.revalidated = i.result.accessed,
                        i.revalidated = !0,
                        a.storeRequest(i.result).then(function() {
                    ...
                    200 == e.status ? (i.result = B(e.url, i.company, i.product, i.accessed, e),
                    i.revalidated = !0,
                    a.storeRequest(i.result).then(function() {
        ...
        return o && (i.control = o.control,
        i.company = o.company,
        i.product = o.product),
        i.result = B(n, i.company, i.product, Date.now()),
        i.revalidated = !1,
        i.enabled ? a.loadRequest(i.result.url).then(function(e) {
            if (!e || e.version !== p.version)
                return s(r, o);
            i.result = e,
            i.result.accessed = Date.now();
            var t, n = new C(i.result.response);
            return "immutable" == i.control ? (i.revalidated = !0,
            a.storeRequest(i.result),
            S("'" + i.result.url + "' served from the indexedDB cache without revalidation"),
            l(n),
            n) : (e = i.result.url,
            (t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0) || !n.headers.get("Last-Modified") && !n.headers.get("ETag") ? (e = (o = o || {}).headers || {},
            o.headers = e,
            ...
            return S("Failed to load '" + i.result.url + "' from indexedDB cache due to the error: " + e),
            g(r, o)
        }) : g(r, o)
    }
    );
                ...
                var t, n = {
                    "inflate.js": function(e, t, n) {
                        ...
                        i.prototype.push = function(e, t) {
                            var n, r, o, a, i, s = this.strm, l = this.options.chunkSize, d = this.options.dictionary, u = !1;
                            if (this.ended)
                                return !1;
                            ...
                            do {
                                ...
                                s.next_out = 0,
                                s.avail_out = l),
                                (n = c.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT && d && (i = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === m.call(d) ? new Uint8Array(d) : d,
                                n = c.inflateSetDictionary(this.strm, i)),
                                n === b.Z_BUF_ERROR && !0 === u && (n = b.Z_OK,
                                u = !1),
                                n !== b.Z_STREAM_END && n !== b.Z_OK)
                                    return this.onEnd(n),
                                    !(this.ended = !0)
                            } while (!s.next_out || 0 !== s.avail_out && n !== b.Z_STREAM_END && (0 !== s.avail_in || r !== b.Z_FINISH && r !== b.Z_SYNC_FLUSH) || ("string" === this.options.to ? (i = h.utf8border(s.output, s.next_out),
                            o = s.next_out - i,
                            ...
                            return (r = n === b.Z_STREAM_END ? b.Z_FINISH : r) === b.Z_FINISH ? (n = c.inflateEnd(this.strm),
                            this.onEnd(n),
                            this.ended = !0,
                            n === b.Z_OK) : r !== b.Z_SYNC_FLUSH || (this.onEnd(b.Z_OK),
                            !(s.avail_out = 0))
                        }
                        ,
                        ...
                        i.prototype.onEnd = function(e) {
                            e === b.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = f.flattenChunks(this.chunks)),
                            this.chunks = [],
                            this.err = e,
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        function l(e, t) {
                            ...
                            t = -t) : (n = 1 + (t >> 4),
                            t < 48 && (t &= 15)),
                            t && (t < 8 || 15 < t)) ? N : (null !== r.window && r.wbits !== t && (r.window = null),
                            r.wrap = n,
                            r.wbits = t,
                            s(e))
                        }
                        ...
                        function W(e, t, n, r) {
                            ...
                            r >= e.wsize ? (L.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
                            e.wnext = 0,
                            e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r),
                            L.arraySet(e.window, t, n - r, o, e.wnext),
                            (r -= o) ? (L.arraySet(e.window, t, n - r, r, 0),
                            e.wnext = r,
                        ...
                        n.inflate = function(e, t) {
                            var n, r, o, a, i, s, l, d, u, c, f, h, b, m, p, g, w, v, y, k, x, _, S, E, C = 0, B = new L.Buf8(4), U = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 5:
                                    ...
                                    n.mode = 6;
                                case 6:
                                    if (1024 & n.flags && ((h = s < (h = n.length) ? s : h) && (n.head && (x = n.head.extra_len - n.length,
                                ...
                                case 7:
                                    if (2048 & n.flags) {
                                        ...
                                        x && h < s; )
                                            ;
                                        if (512 & n.flags && (n.check = I(n.check, r, h, a)),
                                        s -= h,
                                        a += h,
                                        x)
                                            break e
                                ...
                                case 13:
                                    if (n.last)
                                        ...
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            var T, T = R = void 0, R = n;
                                            if (H) {
                                                for (Z = new L.Buf32(512),
                                                j = new L.Buf32(32),
                                                T = 0; T < 144; )
                                                    R.lens[T++] = 8;
                                                for (; T < 256; )
                                ...
                                case 19:
                                    for (; n.have < n.nlen + n.ndist; ) {
                                        for (; g = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !((p = C >>> 24) <= u); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 21:
                                    ...
                                    for (n.back = 0; g = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                    w = 65535 & C,
                                    !((p = C >>> 24) <= u); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (g && 0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (C = n.lencode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !(v + (p = C >>> 24) <= u); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    n.mode = 23;
                                case 23:
                                    for (; g = (C = n.distcode[d & (1 << n.distbits) - 1]) >>> 16 & 255,
                                    w = 65535 & C,
                                    !((p = C >>> 24) <= u); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (C = n.distcode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !(v + (p = C >>> 24) <= u); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 27:
                                    if (n.wrap) {
                                        ...
                                        e.total_out += f,
                                        n.total += f,
                                        f && (e.adler = n.check = (n.flags ? I : O)(n.check, o, f, i - f)),
                                        f = l,
                            ...
                            n.hold = d,
                            n.bits = u,
                            (n.wsize || f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t)) && W(e, e.output, e.next_out, f - e.avail_out) ? (n.mode = 31,
                            -4) : (c -= e.avail_in,
                            f -= e.avail_out,
                            e.total_in += c,
                            e.total_out += f,
                            n.total += f,
                            n.wrap && f && (e.adler = n.check = (n.flags ? I : O)(n.check, o, f, e.next_out - f)),
                        ...
                        n.inflateSetDictionary = function(e, t) {
                            var n, r = t.length;
                            return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? N : 11 === n.mode && O(1, t, r, 0) !== n.check ? -3 : W(e, t, r, r) ? (n.mode = 31,
                            -4) : (n.havedict = 1,
                            D)
                        }
                        ,
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, r, o, a, i, s, l = e.state, d = e.next_in, u = e.input, c = d + (e.avail_in - 5), f = e.next_out, h = e.output, b = f - (t - e.avail_out), m = f + (e.avail_out - 257), p = l.dmax, g = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, x = l.bits, _ = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, C = (1 << l.distbits) - 1;
                            e: do {
                                for (x < 15 && (k += u[d++] << x,
                                x += 8,
                                k += u[d++] << x,
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, r, o, a, i, s) {
                            for (var l, d, u, c, f, h, b, m, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, x = 0, _ = 0, S = 0, E = 0, C = 0, B = 0, U = null, T = 0, R = new A.Buf16(16), L = new A.Buf16(16), O = null, I = 0, w = 0; w <= 15; w++)
                                R[w] = 0;
                            for (v = 0; v < r; v++)
                                R[t[n + v]]++;
                            for (x = g,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (b = w - S),
                                    y = d = 1 << _; o[f + (B >> S) + (d -= l)] = b << 24 | m << 16 | p | 0,
                                    0 !== d; )
                                        ;
                                    for (l = 1 << w - 1; B & l; )
                                        l >>= 1;
                                    ...
                                    if (x < w && (B & c) !== u) {
                                        for (f += y,
                                        E = 1 << (_ = w - (S = 0 === S ? x : S)); _ + S < k && !((E -= R[_ + S]) <= 0); )
                                            _++,
                                            E <<= 1;
                                        if (C += 1 << _,
                                        1 === e && 852 < C || 2 === e && 592 < C)
                ...
                try {
                    for (var n in U) {
                        ...
                        if (U[n].hasUnityMarker(i))
                            ...
                            (r = U[n]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", r.require.toString(), "; this.decompress = ", r.decompress.toString(), "; this.onmessage = ", function(e) {
                                e = {
                                    id: e.data.id,
                    ...
                    if ("undefined" == typeof unityFramework || !unityFramework) {
                        ...
                        for (e in t) {
                            ...
                            if (c.frameworkUrl.endsWith("." + r[0]))
                                ...
                                "file:" == location.protocol ? void d(n + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (n += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + r[1] + '" present. Check browser Console and Devtools Network tab to debug.',
    ...
    return new Promise(function(e, t) {
        c.SystemInfo.hasWebGL ? 1 == c.SystemInfo.hasWebGL ? t('Your browser does not support graphics API "WebGL 2" which is required for this content.') : c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'),
